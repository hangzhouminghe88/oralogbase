/*
   Netpro® - The Network Backup Solution
   ...
   Netpro® is a registered trademark of Kern Sibbald.
   The licensor of Netpro is the Free Software Foundation Europe
   (FSFE), Fiduciary Program, Sumatrastrasse 25, 8006 Zürich,
   Switzerland, email:ftf@fsfeurope.org.
*/
/*
 *  Netpro doubly linked list routines.
 *
 ...
 *
 *   Version $Id: dlist.c 7380 2008-07-14 10:42:59Z kerns $
 *
 */
